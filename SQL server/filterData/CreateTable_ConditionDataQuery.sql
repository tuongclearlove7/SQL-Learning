-- 1/ Tạo DB + Sử dụng DB
Create Database QueryCondition
Go
Use QueryCondition
Go
...
Insert Into GIAOVIEN(MAGV,HOTEN,LUONG,PHAI,NGSINH,DIACHI,QLGVCN)
...
Insert Into SDT_GV(MAGV,DIENTHOAI)
